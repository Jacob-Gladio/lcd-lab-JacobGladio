...
void reactionGame() {
  ...
  lcd.print("ANY SECOND NOW"); // Inform the player to get ready
  ...
  int rndm = random(3000-6000);
  delay(rndm);

  lcd.clear();                 
  lcd.print("PUSH BUTTON");  // Ask the player to press the button as fast as possible
